...
public class Example {
  ...
  public static class _1_2_3 {
    public static void main$1(String args) {
      ...
      LocalChannel._1_2 c2 =
          new LocalChannel._1_2(); // <---| How do we know the if constructor is _12 or _21?
      LocalChannel._1_2 c3 =
          new LocalChannel
              ._1_2(); // <---| Here it is symmetric, but what happens if it is not the case (see
      // other_example)?
      ...
      Integer int_a =
          c3.<Integer>com$2(int_c); // <--- e.g., we need to know the type of int_c (Integer@B)
