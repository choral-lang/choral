...
public class Posts {
  ...
  private Posts(LinkedList<String> followers, LinkedList<String> followed, LinkedList<Post> posts) {
  ...
  static Posts of(List<String> followers, List<String> followed, List<Post> posts) {
    return new Posts(
        new LinkedList<>(followers), new LinkedList<>(followed), new LinkedList<>(posts));
  }
