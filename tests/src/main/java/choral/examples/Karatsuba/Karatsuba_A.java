...
public class Karatsuba_A {
	...
	public static Long multiply(
		...
		if( n1 < 10 || n2 < 10 ) {
			...
			Long h2 = n2 / splitter;
			Long l2 = n2 % splitter;
			Long z0 = ch_AB.< Long >com( Karatsuba_C.multiply( ch_AB.< Long >com( l1 ),
					ch_AB.< Long >com( l2 ), Unit.id, ch_CA, ch_AB ) );
			Long z2 = ch_CA.< Long >com( Karatsuba_B.multiply( ch_CA.< Long >com( h1 ),
					ch_CA.< Long >com( h2 ), ch_CA, ch_AB, Unit.id ) );
