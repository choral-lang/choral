...
public class DistAuth10_IP {
	...
	public DistAuth10_IP(
			TLSChannel_B< Object > ch_Client_IP, TLSChannel_B< Object > ch_Service_IP,
			TLSChannel_B< Object > ch_s1, TLSChannel_B< Object > ch_s2,
			TLSChannel_B< Object > ch_s3, TLSChannel_B< Object > ch_s4,
			TLSChannel_B< Object > ch_s5, TLSChannel_B< Object > ch_s6, TLSChannel_B< Object > ch_s7
	) {
	...
	public Unit authenticate() {
		ch_Client_IP
				.< String >com( ClientRegistry.getSalt( ch_Client_IP.< String >com( Unit.id ) ) );
		Boolean valid =
				ClientRegistry.check( ch_Client_IP.< String >com( calcHash( Unit.id, Unit.id ) ) );
		if( valid ) {
			...
			return Unit.id( ch_Client_IP.< AuthToken >com( t ),
