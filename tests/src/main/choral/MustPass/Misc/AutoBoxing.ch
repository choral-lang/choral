...
public class AutoBoxing@( A, B ) {
        public void f(){
            ...
            numberPrimitive = f1Primitive( 2@A );
            numberObject    = f1Object( Integer@A.valueOf( 2@A ) );
            ...
            f5Objects( Integer@A.valueOf( 2@A ), Integer@A.valueOf( 2@A ) );
            f5Ints( 2@A, 2@A );
        }

        public Integer@A f1Object( Integer@A i ) { return i; }
        public int@A     f1Primitive( int@A i ) { return i; }
        ...
        public void f5Objects( Object@A o1, Object@A o2 ) { }
        public void f5Ints( int@A i1, int@A i2 ) { }
}
