...
public class Karatsuba extends AbstractBehavior<KaratsubaMessage> {
  ...
  private Behavior<KaratsubaMessage> onReceive(KaratsubaRequest n) {
    ...
    if (left < 10 || right < 10) {
      ...
      getContext()
          .spawn(Karatsuba.create(), "Z0")
          .tell(
              new KaratsubaRequest(
                  new KaratsubaOperation(left_l, right_l),
                  getContext().getSelf(),
                  new Z0_KaratsubaResponse()));
      getContext()
          .spawn(Karatsuba.create(), "Z2")
          .tell(
              new KaratsubaRequest(
                  new KaratsubaOperation(left_h, right_h),
                  getContext().getSelf(),
                  new Z2_KaratsubaResponse()));
      getContext()
          .spawn(Karatsuba.create(), "Z1")
          .tell(
              new KaratsubaRequest(
