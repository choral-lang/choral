...
class KaratsubaRequest implements KaratsubaMessage {
  ...
  private final KaratsubaResponse
      response; // this defined the "format" of the response (either complete, Z0, Z1 or Z2)

  public KaratsubaRequest(
      KaratsubaOperation operation, ActorRef<KaratsubaMessage> sender, KaratsubaResponse response) {
