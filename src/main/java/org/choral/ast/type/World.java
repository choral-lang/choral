...
public abstract class World extends Node implements WithTypeAnnotation<org.choral.types.World> {
	...
	private org.choral.types.World typeAnnotation;

	public Optional< ? extends org.choral.types.World > typeAnnotation() {
		return Optional.ofNullable( typeAnnotation );
	}

	public void setTypeAnnotation( org.choral.types.World typeAnnotation ) {
