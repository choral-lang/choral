...
public class Karatsuba_A {
	...
	public static Long multiply( Long n1, Long n2, SymChannel_A < Object > ch_AB, SymChannel_B < Object > ch_CA ) {
		if( n1 < 10 || n2 < 10 ){
			...
			l2 = n2 % splitter;
			Long z0;
			z0 = ch_AB.< Long >com( Karatsuba_C.multiply( ch_AB.< Long >com( l1 ), ch_AB.< Long >com( l2 ), Unit.id, ch_CA, ch_AB ) );
			Long z2;
			z2 = ch_CA.< Long >com( Karatsuba_B.multiply( ch_CA.< Long >com( h1 ), ch_CA.< Long >com( h2 ), ch_CA, ch_AB, Unit.id ) );
			Long z1;
