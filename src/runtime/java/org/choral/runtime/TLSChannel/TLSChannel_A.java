...
public class TLSChannel_A< T > extends TLSChannelImpl< T > implements SymChannel_A< T > {

	public TLSChannel_A( TSLByteChannelImpl channel, ChoralSerializer< Object, ByteBuffer > serializer ){
