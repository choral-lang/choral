...
public class TLSChannel1< T > extends TLSChannelImpl< T > implements SymChannel1< T > {

	public TLSChannel1 ( TSLByteChannelImpl channel, ChoralSerializer< Object, ByteBuffer > serializer ){
