...
public class TLSChannel2< T > extends TLSChannelImpl< T > implements SymChannel2< T > {

	public TLSChannel2 ( TSLByteChannelImpl channel, ChoralSerializer< Object, ByteBuffer > serializer ){
