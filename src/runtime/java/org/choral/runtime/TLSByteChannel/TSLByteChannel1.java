...
public class TSLByteChannel1 extends TSLByteChannelImpl implements SymDataChannel1< ByteBuffer > {

	public TSLByteChannel1 ( SymByteChannelImpl channel, SSLContext sslContext ) {
		this.channel = ClientTlsChannel
			.newBuilder( channel.byteChannel(), sslContext )
			.build();
	}

	public TSLByteChannel1 ( ByteChannel channel, SSLContext sslContext ) {
		this.channel = ClientTlsChannel
