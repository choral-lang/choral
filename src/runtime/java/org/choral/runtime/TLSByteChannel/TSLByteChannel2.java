...
public class TSLByteChannel2 extends TSLByteChannelImpl implements SymDataChannel2< ByteBuffer > {

	public TSLByteChannel2 ( SymByteChannelImpl channel, SSLContext sslContext ) {
		this.channel = ServerTlsChannel
			.newBuilder( channel.byteChannel(), sslContext )
			.build();
	}

	public TSLByteChannel2 ( ByteChannel channel, SSLContext sslContext ) {
		this.channel = ServerTlsChannel
