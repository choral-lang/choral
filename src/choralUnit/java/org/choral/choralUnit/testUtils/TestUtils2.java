...
public class TestUtils2 {
	...
	public static SymChannel2< Object > newLocalChannel( String id ){
		return TestUtils.newLocalChannel( id ).right();
	}

	public static TLSChannel2< Object > newLocalTLSChannel( String id ){
		return TestUtils.newLocalTLSChannel( id ).right();
	}

	public static SymChannel2< Object > newLocalChannel( Unit o, String id ){
		return newLocalChannel( id );
	}

	public static TLSChannel2< Object > newLocalTLSChannel( Unit o, String id ){
