...
public class TestUtils1 {
	...
	public static SymChannel1< Object > newLocalChannel( String id, Unit o ){
		return newLocalChannel( id );
	}

	public static SymChannel1< Object > newLocalChannel( String id ){
		return TestUtils.newLocalChannel( id ).left();
	}

	public static TLSChannel1< Object > newLocalTLSChannel( String id, Unit o ){
		return newLocalTLSChannel( id );
	}

	public static TLSChannel1< Object > newLocalTLSChannel( String id ){
