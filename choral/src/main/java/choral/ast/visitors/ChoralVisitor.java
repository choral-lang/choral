...
public class ChoralVisitor implements ChoralVisitorInterface<Node> {
  ...
  public Node visit(CompilationUnit n) {
    ...
    return new CompilationUnit(
        ...
        classes,
        enums,
        n.position().sourceFile());
  }

  @Override
  public Node visit(ImportDeclaration n) {
    return new ImportDeclaration(n.name(), n.position());
  }

  @Override
  public Node visit(ExpressionStatement n) {
    return new ExpressionStatement(
        safeVisit(n.expression()), safeVisit(n.continuation()), n.position());
  }
  ...
  public Node visit(ReturnStatement n) {
    return new ReturnStatement(
        safeVisit(n.returnExpression()), safeVisit(n.continuation()), n.position());
  }
  ...
  public Node visit(AssignExpression n) {
    return new AssignExpression(
        safeVisit(n.value()), safeVisit(n.target()), n.operator(), n.position());
  }

  @Override
  public Node visit(BinaryExpression n) {
    return new BinaryExpression(
        safeVisit(n.left()), safeVisit(n.right()), n.operator(), n.position());
  }
  ...
  public Node visit(EnumCaseInstantiationExpression n) {
    return new EnumCaseInstantiationExpression(
        safeVisit(n.name()), n._case(), safeVisit(n.world()), n.position());
  }

  @Override
  public Node visit(EnclosedExpression n) {
    return new EnclosedExpression(safeVisit(n.nestedExpression()), n.position());
  }

  @Override
  public Node visit(FieldAccessExpression n) {
    return new FieldAccessExpression(safeVisit(n.name()), n.position());
  }

  @Override
  public Node visit(StaticAccessExpression n) {
    return new StaticAccessExpression(safeVisit(n.typeExpression()), n.position());
  }
  ...
  public Node visit(Name n) {
    return new Name(n.identifier(), n.position());
  }

  @Override
  public Node visit(NotExpression n) {
    return new NotExpression(safeVisit(n.expression()), n.position());
  }
  ...
  public Node visit(VariableDeclarationStatement n) {
    return new VariableDeclarationStatement(
        visitAndCollect(n.variables()), safeVisit(n.continuation()), n.position());
  }
  ...
  public Node visit(CaseSignature n) {
    return new CaseSignature(n.name(), visitAndCollect(n.parameters()), n.position());
  }
  ...
  public Node visit(EnumConstant n) {
    return new EnumConstant(n.name(), visitAndCollect(n.annotations()), n.position());
  }
  ...
  public Node visit(FormalMethodParameter n) {
    return new FormalMethodParameter(
        n.name(), safeVisit(n.type()), visitAndCollect(n.annotations()), n.position());
  }
  ...
  public Node visit(BlockStatement n) {
    return new BlockStatement(
        safeVisit(n.enclosedStatement()), safeVisit(n.continuation()), n.position());
  }

  @Override
  public Node visit(ScopedExpression n) {
    return new ScopedExpression(
        safeVisit(n.scope()), safeVisit(n.scopedExpression()), n.position());
  }
  ...
  public Node visit(WorldArgument n) {
    return new WorldArgument(n.name(), n.position());
  }

  @Override
  public Node visit(FormalWorldParameter n) {
    return new FormalWorldParameter(n.name(), n.position());
  }

  @Override
  public Node visit(Annotation n) {
    return new Annotation(n.getName(), n.getValues(), n.position());
  }
