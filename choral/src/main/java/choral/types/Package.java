...
/**
 * This class represents a package, like `java.util` or `com.example.foo`. It keeps track of all
 * packages and types declared inside it. For example, `java.util` is a Package declared in the
 * `java` package, and `java.util.Collection` is a type declared in the `java.util` Package.
 */
public class Package {
  ...
  /**
   * Returns the parent Package in which this Package was declared. For example, the `java` package
   * is the declaration context of the `java.util` package.
   */
  public Package declarationContext() {
  ...
  /**
   * Locates a type matching the given qualified name inside this package---returning nothing if no
   * such type exists. If this package is 'java' and the qualified name is 'util.Iterator', the
   * method will look for a type that has fully qualified name 'java.util.Iterator'.
   */
  ...
  final void registerDeclaredType(HigherClassOrInterface type) {
    ...
    if (declaredTypes.containsKey(type.identifier())
        || declaredPackages.containsKey(type.identifier())) {
