...
/**
 * Scope for static members of a class or interface. Allows you to look up world (role) parameters
 * (e.g. {@code A, B} in {@code class Foo@(A,B)}) using {@link #lookupWorldParameter}, as well as
 * static methods using {@link #getScope(Member.HigherCallable)}.
 */
public final class ClassOrInterfaceStaticScope extends ChildScope implements ClassOrInterfaceScope {
