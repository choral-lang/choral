...
/**
 * Scope for instance members of a class or interface. Allows you to look up the scope of type
 * parameters and instance methods declared by the class or interface. Enclosed within {@link
 * ClassOrInterfaceStaticScope}, which allows you to look up static members and world parameters.
 */
public final class ClassOrInterfaceInstanceScope extends ChildScope
