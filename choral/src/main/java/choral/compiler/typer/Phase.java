 ...
 * valid to implement a method foo on line 10 that uses a method bar on line 20. For this to work,
 * we have to split up typechecking into multiple phases:
 *
 * <ol>
 *   <li>Type symbol declarations: Declare all the packages, classes, interfaces, and enums without
 *       inspecting their contents.
 *   <li>Hierarchy: Check if the inheritance hierarchy is ok. This phase detects inheritance cycles,
 *       like when Foo extends Bar and Bar extends Foo.
