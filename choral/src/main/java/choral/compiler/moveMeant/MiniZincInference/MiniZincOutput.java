...
public class MiniZincOutput {
  ...
  public void insertSelection(
      World recipient, World sender, List<Pair<String, GroundInterface>> channels, Integer idx) {
    ...
    if (selectionMethod == null)
      throw new CommunicationInferenceException(
          "No viable selection method was found for " + recipient + " with sender " + sender);
