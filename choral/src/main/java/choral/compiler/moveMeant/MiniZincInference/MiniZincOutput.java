...
public class MiniZincOutput {
	...
	public void insertDataCom( Integer idx, Dependency dep ) {
		...
		dependencyVariables.put( dep, new Name( "dependencyAt" + dep.recipient() + "_"
				+ Math.abs( dep.originalExpression().hashCode() ) ) );
	}
	...
	public void insertSelection(
		...
		if( selectionMethod == null )
			throw new CommunicationInferenceException( "No viable selection method was found for "
					+ recipient + " with sender " + sender );
