 ...
 *
 * <p>Generate the input as a string using {@code toString()}
 */
public class MiniZincInput {
  ...
  public static class Dependency {
     ...
     *
     * <p>If no viable channel can be found, an exception is thrown.
     */
    public void setComMethod(List<Pair<String, GroundInterface>> channels) {
        ...
        if (channel.typeArguments().stream()
          ...
          Optional<? extends HigherMethod> comMethodOptional =
              channelPair
                  ...
                  .filter(
                      method ->
                          method.identifier().equals("com")
                              && // it is a com method (only checked through name)
                              method
                                  .innerCallable()
                                  .signature()
                                  .parameters()
                              ...
                              && // probably redundant check, returntype should not be able to be
                              // void
                              ((GroundDataType) method.innerCallable().returnType())
                                  .worldArguments()
                                  .get(0)
                                  .equals(recipient)) // its returntype's world is equal to our
      ...
      throw new CommunicationInferenceException(
          "No viable communication method was found for the dependency " + originalExpression());
    }
  }
}
