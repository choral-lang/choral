...
public class BasicDataInference {
   ...
   * expression has more than one sender worldm an error is thrown.
   *
  ...
  private class VisitStatement extends AbstractChoralVisitor<Statement> {
    ...
    public Statement visit(BlockStatement n) {
      ...
      return new BlockStatement(
          visit(n.enclosedStatement()), visitContinutation(n.continuation()), n.position());
    }
   ...
   * dependencyList}. If an {@code Expression} is equal to a dependency it is replaced with a
   * communication.
   */
