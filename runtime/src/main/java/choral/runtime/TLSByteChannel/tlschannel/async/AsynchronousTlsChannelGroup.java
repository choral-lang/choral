 ...
 * possible to run a group of asynchronous choral.channels.
 */
public class AsynchronousTlsChannelGroup {
  ...
  //            logger.warn(
  //                    "caught {}; choral.channels used in asynchronous groups should run tasks
  // themselves; " +
  //                            "although task is being dealt with anyway, consider configuring
  // choral.channels properly",
