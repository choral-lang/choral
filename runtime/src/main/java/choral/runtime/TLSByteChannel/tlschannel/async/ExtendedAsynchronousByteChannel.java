...
public interface ExtendedAsynchronousByteChannel extends AsynchronousByteChannel {
   ...
   * </blockquote>
   *
   * <p>at the moment that the read is attempted.
   *
   * <p>Suppose that a byte sequence of length <i>n</i> is read, where
   * <tt>0</tt>&nbsp;<tt>&lt;</tt>&nbsp;<i>n</i>&nbsp;<tt>&lt;=</tt>&nbsp;<i>r</i>. Up to the first
   ...
   * to be equal to that buffer's limit. The underlying operating system may impose a limit on the
   * number of buffers that may be used in an I/O operation. Where the number of buffers (with bytes
   * remaining), exceeds this limit, then the I/O operation is performed with the maximum number of
   * buffers allowed by the operating system.
   *
   ...
   * </blockquote>
   *
   * <p>at the moment that the write is attempted.
   *
